...
- **🖥️ Homelab**: Postawiłem własny lokalny serwer NAS (OpenMediaVault) oraz środowiska do lokalnego uruchamiania LLM (Ollama, Stable Diffusion).
...
- **🛠️ Naprawy:** niewielki serwis sprzętu na własną rękę (wymiana części, chłodzenia, itp.)
